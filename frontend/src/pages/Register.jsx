    ...
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3.5">
        ...
        <div>
          ...
          <select
            className="w-full bg-bg-3 border border-border rounded-lg px-3 py-2.5 text-sm text-white outline-none focus:border-accent focus:ring-1 focus:ring-accent/25 transition-all"
