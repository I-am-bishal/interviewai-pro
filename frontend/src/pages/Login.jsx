  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-slate-400 text-sm">Continue your interview prep journey</p>
      </div>
      ...
      <div 
        ...
        className="mt-6 p-3 bg-accent/5 border border-accent/15 hover:bg-accent/10 hover:border-accent/30 cursor-pointer rounded-lg text-xs text-slate-500 text-center transition-all group duration-200"
      >
