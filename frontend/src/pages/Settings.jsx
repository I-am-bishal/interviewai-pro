...
const Settings = () => {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="p-6 max-w-2xl mx-auto relative overflow-hidden">
      <div className="ambient-orb ambient-orb-1 absolute -top-48 left-1/4" />

      <div className="mb-7 relative z-10">
        <h1 className="font-heading text-2xl font-extrabold mb-1 tracking-tight">Settings</h1>
        <p className="text-slate-500 text-sm">Manage your account, preferences and API keys</p>
      </div>
        ...
        <Section title="Profile">
          <div className="flex items-center gap-4 mb-5">
            ...
            <div>
              ...
              <div className="mt-1 flex gap-2">
                <Badge color={user?.plan === 'pro' ? 'purple' : 'gray'}>
          ...
          <form onSubmit={handleSubmit(onSaveProfile)} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              ...
              />
              <div>
                <label className="block text-xs text-slate-500 mb-1.5 font-medium tracking-wide">Experience Level</label>
                <select
                  className="w-full bg-bg-3/60 backdrop-blur-sm border border-border/60 rounded-xl px-3.5 py-2.5 text-sm text-slate-900 outline-none focus:border-accent/50 focus:ring-2 focus:ring-accent/10 transition-all duration-300"
        ...
        <Section title="Preferences">
          <div className="space-y-0">
            {[
              ...
              <div key={key} className="flex items-center justify-between py-3.5 border-b border-border/30 last:border-0">
